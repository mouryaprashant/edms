      ...
      <div className="mx-auto flex h-[72px] max-w-[1800px] items-center gap-3 px-3 sm:px-5 lg:px-6">
        ...
        <div className="flex min-w-[190px] items-center gap-3">
          ...
          <div className="hidden sm:block leading-tight">
            <div className="text-sm font-extrabold tracking-wide">Railway Directory</div>
            <div className="text-[10px] font-medium uppercase tracking-[.18em] text-slate-400">Section & Station Portal</div>
          </div>
        </div>
