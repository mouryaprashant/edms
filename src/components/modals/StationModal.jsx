...
export default function StationModal({ open, sections, editingSectionId, editingStationId, onClose, onSave, onNeedsSectionFirst }) {
  ...
  return (
    <div className="modal-backdrop">
      <div className="modal-panel modal-panel-lg max-h-[92vh] flex flex-col overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="mt-4 flex min-h-0 flex-1 flex-col">
          <div className="min-h-0 flex-1 overflow-y-auto custom-scrollbar pr-1 space-y-4">
          ...
          <div className="flex shrink-0 justify-end gap-2 border-t border-slate-100 bg-white pt-4">
